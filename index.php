...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">+ 7448 1990 84</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">bhoyarachal1@gmail.com</span>
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('images/abc.jpg');" data-section="home" data-stellar-background-ratio="0.5">
        ...
        <div class="row">
            ...
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                ...
                <p>We 	will   help    your   to    find   your    perfect    home   wherever     you       wont .</p>
              </div>
            </div>      
          </div>
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-lg-4">
              ...
              <div class="media-body">
                ...
                <p>We have agents that work all over the city.</p>
              </div>
            </div>      
          </div>
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                ...
                <p>we have the properties that are available at best price on rent.</p>
              </div>
            </div>      
          </div>
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-lg-4">
              ...
              <div class="media-body">
                ...
                <p>make a money for your dream house.</p>
              </div>
            </div>      
          </div>
        </div>
    ...
    <section class="ftco-intro img" id="about-section" style="background-image: url(img/achal.jpg);">
			<div class="overlay"></div>
			<div class="container">
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/ani.jpg);">
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 px-lg-5 py-md-5">
    				<div class="py-md-5">
			          ...
			          <div class="col-md-12 heading-section ftco-animate p-4 p-lg-5">
			            ...
			            <p>Stayhome Real Estate is a well-established property brokerage agency. We strongly believe in meeting our consumer’s every need by offering a complete solution of real estate services, from sales, rentals to mortgage and new developments.</p>
			            <p>Our team of innovate professionals work with passion & transparency to get desired results.</p>
			            <p>Our core area of business is towards commercial corporate leasing on all-India basis and we have been confidently delivering excellent services through integration of empowered people, combined with 30 years of experience and expertise.</p>
    ...
    <section class="ftco-section ftco-services-2 bg-light" id="workflow-section">
          ...
          <div class="col-md-4 heading-section ftco-animate">
            ...
            <div class="media block-6 services text-center d-block pt-md-5 mt-md-5">
              ...
              <div class="media-body p-md-3">
                ...
                <p class="mb-5">You can evaluate the property by  taking into account the markety value of the property.</p>
                <hr>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate mt-lg-5">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-md-5 pt-lg-4">
              ...
              <div class="media-body p-md-3">
                ...
                <p class="mb-5">My client include current residents and people wanting to relocate to scottsdale or paradise valley I can help you if this is your first home or goif course community, or if you wangt a second home or vacation get away home.</p>
                <hr>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body p-md-3">
                ...
                <p class="mb-5">1) Do your research. 				2) set expectation. 	3) pitc the solution, not the property.					4) Handle objections.		5) Ask for the sale. 				6) Arrange the next step.</p>
                <hr>
              </div>
            </div>      
          </div>
		...
		<section class="ftco-intro img" id="hotel-section" style="background-image: url(img/abh.jpg);">
			<div class="overlay"></div>
			<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <div class="carousel-agent owl-carousel">
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="img/ABCD.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
			    				<div class="desc pt-3">
			    					<div>
				    					<h3><a href="properties.html">Achal Bhoyar</a></h3>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="img/AB3.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
			    				<div class="desc pt-3">
			    					<div>
				    					<h3><a href="properties.html">Jayshree Yaduwanshi</a></h3>
											<p class="h-info"><span class="location">Listing</span> <span class="details">&mdash; 10 Properties</span></p>
										</div>
			    				</div>
		    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="img/AB2.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
			    				<div class="desc pt-3">
			    					<div>
				    					<h3><a href="properties.html">Manish Hedau</a></h3>
											<p class="h-info"><span class="location">Listing</span> <span class="details">&mdash; 10 Properties</span></p>
										</div>
			    				</div>
		    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="img/ABCDE2.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
			    				<div class="desc pt-3">
			    					<div>
				    					<h3><a href="properties.html">Priyanka Rautray</a></h3>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(img/dharti.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text px-4 pb-5">
                    <p class="mb-4">They are the best in the World and I really appriciate the service they provide to me. It  is due to Om only that I got my dream home in Nagpur.</p>
                    <p class="name">Dharti Nandanwar</p>
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(img/pragati.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text px-4 pb-5">
                    <p class="mb-4">Om has an excellent knowledge of realestate & understands the best options & the future for individual residential properties, I definitely recommend him.</p>
                    <p class="name">Pragati Bhoyar</p>
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(img/img40.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text px-4 pb-5">
                    <p class="mb-4">Om  Wairale  once  again  provided  excellent  professional  service  in  securing our  new  office   and  assisting   in  the  negotiations.</p>
                    <p class="name">Huzef Kureshi</p>
                    <span class="position">Dancer</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(img/switi.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text px-4 pb-5">
                    <p class="mb-4">We would like to extend our sincere thanks to you Om for the way you conducted the things for us. Your professional yet friendly manner at all times is greatly appreciated.</p>
                    <p class="name">Switi Bhoyar</p>
                    <span class="position">Artist</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(img/ankit.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text px-4 pb-5">
                    <p class="mb-4">I just wanted to thank you for all the extras efforts you have taken as Real Estate Agent and as far as we are concerned that title doesn not fit you at all, you are way more than that Om.</p>
                    <p class="name">Aniket Bawankule</p>
		          ...
		          <div class="col-md-12 ftco-animate">
		          	<div class="box p-2 px-3 bg-light d-flex">
		          		...
		          		<div>
				            ...
				            <p> Gumgaon mine khapa 441101 , saoner ,Nagpur ,India.</p>
			            </div>
			          </div>
		          </div>
		          <div class="col-md-12 ftco-animate">
		          	<div class="box p-2 px-3 bg-light d-flex">
		          		...
		          		<div>
				            ...
				            <p><a href="tel://1234567920">+ 7448 1990 84</a></p>
			            </div>
			          </div>
		          </div>
		          <div class="col-md-12 ftco-animate">
		          	<div class="box p-2 px-3 bg-light d-flex">
		          		...
		          		<div>
				            ...
				            <p><a href="mailto:info@yoursite.com">bhoyarachal1@gamil.com</a></p>
			            </div>
			          </div>
		          </div>
		          <div class="col-md-12 ftco-animate">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Gumgaon mine khapa 441101 ,Th.saoner, D. Nagpur, India </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+7448 1990 84</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope pr-4"></span><span class="text">bhoyarachal1@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
