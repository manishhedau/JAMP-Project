...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap hero-wrap-2" style="background-image: url('img/bg2.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="img/sagr.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
                <h3>Sagar Satpute</h3>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="img/mnish.jpg" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>Mnish Raut</h3>
                    <div class="meta">October 03, 2018 at 2:21pm</div>
                  ...
                  <ul class="children">
                    <li class="comment">
                      <div class="vcard bio">
                        <img src="img/rahul.jpg" alt="Image placeholder">
                      </div>
                      <div class="comment-body">
                        <h3>Rahul Ramteke</h3>
                        <div class="meta">October 03, 2018 at 2:21pm</div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="img/2.jpg" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>pankaj Kolhe</h3>
                    <div class="meta">October 03, 2018 at 2:21pm</div>
